...
const transaction={
    ...
    addTransaction(newTransaction, callback){
        return db.query("INSERT INTO transaction VALUES(?,?,?,?,?)",[newTransaction.idaccount,newTransaction.time,newTransaction.transactionamount, newTransaction.transactiontype,newTransaction.cardnumber],callback);
    },
